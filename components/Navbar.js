...
export default function Navbar() {
  return (
    <div className="flex flex-row justify-between items-center px-48 text-secondary py-0">
      <div className="logo text-4xl opacity-85 uppercase font-semibold bg">
        <Link href="/">
          <Image src="/logo.svg" height={180} width={180} alt="Logo"></Image>
        </Link>
      </div>
      <div className="flex flex-row justify-between items-center lowercase opacity-80 text-2xl">
        ...
        <div className="link">
          <Link href="/login">register your EV</Link>
        </div>
      </div>
    </div>
  )
